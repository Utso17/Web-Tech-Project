...
<div class="choose-club">
    <div class="individual-club">
        <img src="../asset/donor/wildfare.png" alt="" height="180px" width="200px">
    ...
    <div class="individual-club">
        <img src="../asset/donor/kids.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
    ...
    <div class="individual-club">
        <img src="../asset/donor/homeless.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
    ...
    <div class="individual-club">
        <img src="../asset/donor/freedom.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
    ...
    <div class="individual-club">
        <img src="../asset/donor/students.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
    ...
    <div class="individual-club">
        <img src="../asset/donor/leader.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
    ...
    <div class="individual-club">
        <img src="../asset/donor/business.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
    ...
    <div class="individual-club">
        <img src="../asset/donor/playground.png" alt="" height="180px" width="200px">
        <form action="" method="POST">
