...
if(isset($_POST['submit_invite'])){
    ...
    $email = $_POST['email'];
    echo "<h3 style='text-align:center;color:green;'>An Invitation Email Sent to ".$email." !!<a style='color:darkgreen;text-decoration:none;' href='donor-home.php'>Go To Home</a></h3>";
}
?>
...
<body>
    ...
    <div>
        ...
        <div class="payment-method">
            ...
            <div>
                <img src="../asset/donor/invite.png"  alt="" height="300px" width="310px">
            </div>
        </div>
    </div>
    </div>
