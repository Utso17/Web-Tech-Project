...
<body>
    ...
    <script type="text/javascript">
        ...
        $('#btn-mobile').click(() => {
            ...
            var string = "DonationType=Paid&PaidType=Mobile";
            string += "&MobileNo=" + $('#mobile-no').val();
            string += "&Trnix=" + $('#trnix').val();
            string += "&Money=" + $('#amt').val();
        ...
        $('#btn-card').click(() => {
            ...
            var string = "DonationType=Paid";
            string += "&PaidType=Card";
            string += "&CreditCard=" + $('#CreditCard').val();
            string += "&ExpiryMonth=" + $('#ExpiryMonth').val();
            string += "&ExpiryYear=" + $('#ExpiryYear').val();
            string += "&CVV=" + $('#CVV').val();
            string += "&Money=" + $('#amt').val();
        ...
        $('#btn-free').click(() => {
            ...
            var string = "DonationType=Free";
            string += "&FreeType=" + FreeType;
            string += "&Money=" + $('#amt').val();
